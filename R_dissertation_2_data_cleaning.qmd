...
Do you remember from the [first worksheet how we calculated BMI and waist-to-hip ratio](https://andrewmoles2.github.io/DSL-R-Website/R_dissertation_1_first_steps.html#starting-off-calculate-your-own-health-metrics){target="_blank"}? How do we do those calculations on columns in a data frame to make a new column?
...
We are always looking to improve and iterate our workshops. [Follow the link below to give your feedback](https://lse.eu.qualtrics.com/jfe/form/SV_6eSrOVWuit28qcS?coursename=R%Dissertation%Masterclass%2:%Data%cleaning&topic=R&prog=DS&version=23-24&link=https://lsecloud.sharepoint.com/:u:/s/TEAM_APD-DSL-Digital-Skills-Trainers/Edgg9b6Z8h5AutxeNn76ptsBlc7R5nbQxzcuYZgjD4EAdA?e=hv9Mti){target="_blank"}. 
