...
1. This time you will be opening your own R script or R Markdown file. 
...
[R tutor](https://www.r-tutor.com/elementary-statistics) which provides short examples of lots of statistical tests. 

[R statistics tutorials](https://r-statistics.co/Statistical-Tests-in-R.html ) which are longer tutorials on models like regression.     
...
We are always looking to improve and iterate our workshops. [Follow the link below to give your feedback](https://lse.eu.qualtrics.com/jfe/form/SV_6eSrOVWuit28qcS?coursename=R%Dissertation%Masterclass%4:%Data%analysis&topic=R&prog=DS&version=23-24&link=https://lsecloud.sharepoint.com/:u:/s/TEAM_APD-DSL-Digital-Skills-Trainers/EVZS7bpU_gZElOQg922p9KMBRH0NOttxEmUPvt6TJY_bKg?e=nzwPzl). 
